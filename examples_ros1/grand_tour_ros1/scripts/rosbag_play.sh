...
declare -A flag_to_keys=(
    ...
    [--lidars]="*livox.bag *livox_undist.bag *anymal_velodyne.bag *anymal_velodyne_undist.bag *hesai.bag *hesai_undist.bag"
    ...
    [--imus]="*adis.bag *stim320_imu.bag *alphasense_imu.bag *cpt7_imu.bag *ap20_imu.bag *anymal_imu.bag"
    [--dlio]="*dlio.bag"
